...
export default function ViewerDashboard() {
  ...
  useEffect(() => {
    ...
    if (parsed.role !== 'viewer') { router.push('/'); return }
    setUser(parsed)
  }, [])
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .nav-label-sistema { display: none; }
      ...
      <div className="dash">
        <div className="sidebar">
          ...
          <div className="nav-section">
            ...
            <div className="nav-label nav-label-sistema">Sistema</div>
            {sistema.map(item => (
              <button
                key={item.key}
                className={`nav-item ${active === item.key ? 'active' : ''}`}
          ...
          <div className="sidebar-footer">
            <div className="user-row">
              ...
              <div>
                ...
                <div className="user-role-badge">Visualizador</div>
              </div>
